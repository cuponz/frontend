          ...
          {showEmailField && (
            <div className="mb-4">
              <input
                ...
                placeholder={isEmailDisabled ? "Email (auto-filled from your account)" : "Email"}
                value={isEmailDisabled ? "Email (auto-filled from your account)" : formData.email}
              ...
              {isEmailDisabled && (
                <p className="text-sm text-gray-500 mt-1">
                  Email input is disabled as both email and phone are required, and you haven't provided a phone number.
                </p>
              )}
            </div>
          )}
