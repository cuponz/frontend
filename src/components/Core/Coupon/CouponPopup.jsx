  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg w-96 p-6 relative shadow-lg border-4 border-gray-300">
        ...
        {!coupon.url && (
          <>
            <div className="text-center text-black text-xl font-normal font-['Inder']">
              OR
            </div>
        ...
        <br />
        <div>
          <span className="text-[#46467a] text-base font-bold">
            Expiration Date:
          </span>
          <span className="text-[#183346] text-base font-normal">
            {" " + formattedDate}
          </span>
        </div>
        ...
        {coupon.url ? (
          <p className="mt-4">
            ...
            <Link href={coupon.url} className="text-blue-500 underline">
              {coupon.url}
            </Link>
          </p>
        ) : (
          <p className="mt-4">
            ...
            <a href={redemptionLink} className="text-blue-500 underline">
              {redemptionLink}
            </a>
          </p>
        )}
